# Yosurf — Brief commercial & marketing v2

> _yo, ta vague est prête._

**Yosurf** est la carte vivante des vagues, conçue pour rendre la prévision de surf belle, instantanée et gratuite. **Couverture v2 : 6 pays, 395 spots** (France 285, Espagne Atlantique 38, Canaries 19, Portugal 40, Maroc 19, UK 15, Irlande 10). i18n prête (FR/EN/ES/PT).

**Statut actuel (mai 2026)** : MVP en production, infrastructure de monétisation prête (AdSense, affiliation, newsletter, premium waitlist, analytics).
...
| **Couverture v2** | 395 spots / 6 pays / 13 régions / i18n FR-EN-ES-PT |
...
### Phase 1 — France + ES + PT + MA + UK + IE (✅ TERMINÉE)
**Status** : ✅ Livré en v2 — couverture multipays opérationnelle dès J1
